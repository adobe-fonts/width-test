...
* CIDs 3 through 6 are additionally mapped from one (U+0031) through four (U+0034) for the purpose of easing the creation of reference tests. CID+3 is also mapped to full-width zero (U+FF10).
